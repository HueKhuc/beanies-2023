...
<footer>
    <form class = "m-3" style="width:50%;" method="post" action="">
        ...
        <div class="form-floating mb-3">
            <input type ="text" class="form-control" placeholder="Sujet" id="floatingTextarea" name="<?php echo $sujet;?>" required>
            <label for="floatingTextarea">Sujet</label>
        </div>   
        <div class="form-floating mb-3">
            <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="<?php echo $email;?>">
            <label for="floatingInput">Email address</label>
        </div>
        <div class="form-floating mb-3">
            <textarea class="form-control" placeholder="Votre message" id="floatingTextarea2" style="height: 100px" name="<?php echo $message;?>"  required></textarea>
